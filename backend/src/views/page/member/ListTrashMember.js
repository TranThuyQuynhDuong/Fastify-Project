...
function ListTrashMember() {
    ...
    useEffect(() => {
        apiMember.getListTrash('admin').then((res) => {
            setListTrash(res);
    ...
    function rescoverTrash(id) {
        apiMember.rescoverTrash(id).then(function (result) {
    ...
    const delMember = async (id) => {
        apiMember.delMemberById(id).then((res) => {
            try {
                                                    ...
                                                    <tr className="datarow" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div className="function_style" style={{ fontSize: "14px" }}>
                                                                ...
                                                                <button onClick={() => delMember(item.id)} className="btn btn-sm"><i className="fa fa-trash me-1"></i>Xoá</button>
                                                            </div>
                                                        </td>
                                                        <td>{item.email}</td>
                                                        <td>{item.phone}</td>
...
export default ListTrashMember;