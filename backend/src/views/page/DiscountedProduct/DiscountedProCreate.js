                                            ...
                                            return (
                                                <tr className="datarow" key={index}>
                                                    ...
                                                    <td className="text-center">
                                                        {/* <Link to= {`/discounted/discuntedcreate/${item.id}`} className="btn btn-success btn-sm">Thiết lập</Link> */}
                                                        <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <Link to={`/discounted/discuntedcreate/${item.id}`}>
                                        <CButton color="primary" className="me-md-2">Thêm ưu đãi</CButton>
                                    </Link>
                                </div>
                                                    </td>
