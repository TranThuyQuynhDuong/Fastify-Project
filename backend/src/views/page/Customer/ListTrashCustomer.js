                ...
                <section className="content">
                    <div className="card">
                        <div className="card-header text-right">
                            <Link to="/customer/customerlist" className="btn btn-sm btn-info">
                                                    ...
                                                    <tr className="datarow" key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div className="function_style" style={{ fontSize: "14px" }}>
                                                                {/* <Link to={`/customer/customerdetail/${item.id}`} className="btn btn-sm"><i className="fa fa-eye me-1"></i>Chi tiết</Link> | */}
