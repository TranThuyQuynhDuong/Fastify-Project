            ...
            <section className="content-header">
                <div className="container-fluid">
                    <div className="row mb-2">
                        ...
                        <Link to="/order/ordercancel/1/10" className="action-btn" style={{ color: "red" }}>
                                <CIcon icon={cilTrash} title="Download file" />
                                
                                <sup className="count ms-1">{qty_cancel}</sup>
                                
                            </Link>

                        <div className="col-sm-2  text-right">
                            {/* <Link class="action-btn btn" to="/order/ordercancel/1/10" style={{ color: "red" }}>
                                Đơn hủy
