                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-1 mt-2 text-right">
                            <Link to="/sale/list-trash" className="action-btn" style={{ color: "red" }}>
                            ...
                            <div className="col-md-4">
                                <form onSubmit={handleSubmit} >
                                    ...
                                    <div className="card-header text-right">
                                        <button className="btn btn- btn-success1">
                                        <CButton color="primary" className="me-md-2">Lưu</CButton>
                                        </button>
                                                ...
                                                <tr className="datarow" key={index}>
                                                    ...
                                                    <td style={{ width: "30%" }}>
                                                        ...
                                                        {/* <div className="function_style">
                                                            ...
                                                            <Link to={`/sale/saleupdate/${item.id}`} className="btn btn-sm"><i className="fa fa-edit me-1" ></i>Chỉnh sửa</Link> |
                                                            <Link to={`/sale/saledetail/${item.id}`} className="btn btn-sm"><i className="fa fa-eye me-1"></i>Chi tiết</Link> |
                                                    ...
                                                    <td>
                                                    <div className="function_style" class="text-center">

                                                        <Link to={`/sale/saleupdate/${item.id}`} className="btn btn-sm"><FaEdit /> Chỉnh sửa</Link> |
                                                        <Link to={`/sale/saledetail/${item.id}`} className="btn btn-sm"><FaEye /> Chi tiết</Link> |
                                                        <button onClick={() => trashSale(item.id)} className="btn btn-sm"><FaTrash /> Xoá</button>
                                                    </div>
                                                </td>
                                                </tr>
                                            );
