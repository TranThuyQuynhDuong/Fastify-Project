...
function ProductShow() {
    ...
    const [image_related, setImageRelated] = useState([]);
    ...
    useEffect(() => {
        apiProduct.getProductById(id).then((res) => {
            try {
                ...
                // setImageRelated(res.data.image_related);
                    ...
                    <div className="card-body p-2">
                        <table className="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>Hình ảnh Detail</th>
                                    <td><img style={{ width: "150px" }} src={imageURL + data.image_detail} /></td>
                                </tr>
                                {/* <tr>
                                    <th>Hình ảnh liên quan</th>
                                    <td>
                                        {image_related.map((item, index) => {
                                            return (
                                                <img className="" style={{ width: "150px" }} src={imageURL + item.image} key={index} />
                                            )
                                        })}
                                    </td>
                                </tr> */}
