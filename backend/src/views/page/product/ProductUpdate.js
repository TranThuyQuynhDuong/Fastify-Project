...
function ProductUpdate() {
    ...
    // const [image_related_1_db, setImageR1Db] = useState('');
    // const [image_related_2_db, setImageR2Db] = useState('');
    ...
    useEffect(() => {
        (async () => {
            await apiProduct.getProductById(id).then(res => {
                ...
                // if(res.data.image_related.length > 0){
                //     setImageR1Db(res.data.image_related[0].image);
                //     setImageR2Db(res.data.image_related[1].image);    
                // }
            })
    ...
    const handleSubmit = async (e) => {
        ...
        if (name !== '' && detail_1 !== '' && detail_2 !== '') {
            ...
            const data = {
                ...
                // image: {
                //     image_related_1: image_related_1_db,
                //     image_related_2: image_related_2_db,
                // },
            ...
            // if (image_related_1.files.length > 0) {
            //     const imageUrls = await uploadImages([
            //         image_related_1.files[0],
            //     ]);
            //     data.image.image_related_1 = imageUrls[0];
            // }

            // if (image_related_2.files.length > 0) {
            //     const imageUrls = await uploadImages([
            //         image_related_2.files[0],
            //     ]);
            //     data.image.image_related_2 = imageUrls[0];
            // }
    ...
    return (
        <div className="content-wrapper">
            {/* {console.log(image_related_1_db)} */}
                                ...
                                <form onSubmit={handleSubmit} className="row">
                                    ...
                                    <div className="col-4">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input id="image_related_1" type="file" name="image" className="form-control" />
                                            <br />
                                            <label>Hình ảnh liên quan 2(*)</label>
                                            <input id="image_related_2" type="file" name="image" className="form-control" /> */}
                                        </div>
                                        <div className="mb-3">
