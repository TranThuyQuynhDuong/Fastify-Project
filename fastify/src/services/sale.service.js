...
const createSale = async (db, { name, description, percent_sale, status }) => {
    return new Promise((resolve, reject) => {
        ...
        db.query(
            `INSERT INTO sale (name, slug, description, percent_sale ,created_at, status) VALUES ( ?, ?, ?, ?, ?, ?)`,
            [name, formattedSlug, description, percent_sale, createdAt, status],
            (err, results) => {
                if (err) {
...
const updateSale = async (db, { name, description, percent_sale, price_sale, status }, id) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        db.query(
            `UPDATE sale SET name = ?, slug = ?, description = ? , percent_sale = ?, updated_at = ? , status = ? WHERE id = ?`,
            [name, formattedSlug, description, price_sale, percent_sale, updatedAt, status, id],
            (err, results) => {
                if (err) {
