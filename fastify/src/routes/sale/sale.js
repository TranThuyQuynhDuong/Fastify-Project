...
module.exports = function (fastify, opts, done) {
    ...
    fastify.post('/api/sale/create',{schema: saleShema.createSaleSchema}, saleHandler.createSale);

    fastify.put('/api/sale/update/:id', {schema: saleShema.updateSaleSchema}, saleHandler.updateSale);
    ...
    fastify.delete('/api/sale/delete/:id', {schema: saleShema.deleteSaleSchema}, saleHandler.deleteSale);
