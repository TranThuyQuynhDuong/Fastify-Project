...
module.exports = function (fastify, opts, done) {
    ...
    fastify.post('/api/discounted-products/create',{schema: discountShema.createDiscountedProSchema}, discountHandler.createDiscountedPro);
    ...
    fastify.delete('/api/discounted-products/delete/:id',{schema: discountShema.deleteDiscountedProSchema}, discountHandler.deletePro);

    fastify.put('/api/discounted-products/update/:id',{schema: discountShema.updateDiscountedProSchema}, discountHandler.updateDiscountedPro);
