                            ...
                            <article className="card mb-3">
                                <div className="card-body">
                                    ...
                                    <figure className="icontext">
                                        <div className="icon">
                                            <h1>icon</h1>{/* <img className="rounded-circle img-sm border" src={img_avt} style={{ height: "80px", width: "80px" }} /> */}
                                        </div>
                                        <div className="text">
                                    ...
                                    {data.address_1 ? (
                                        <p>
                                            <i className="fa fa-map-marker text-muted"></i> &nbsp; <b>Địa chỉ mặc định: </b>{data.address_1}
                                    ...
                                    {data.address_2 ? (
                                        <p>
                                            <i className="fa fa-map-marker text-muted"></i> &nbsp; <b>Địa chỉ 2: </b>{data.address_2}
