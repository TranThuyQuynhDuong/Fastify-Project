                        ...
                        <div className='col-md'>
                            ...
                            <ul className="pagination">
                                <li className="page-item">
                                    {page > 1 ? (
                                        <Link className="page-link" color='#ff6a00' to={`/tin-tuc/${slug}/${page - 1}/${limit}`}>Trước</Link>
                                    ) : (
                                ...
                                {Array.from(Array(pages).keys()).map((index) => (
                                    ...
                                    >
                                        <Link
                                            className="page-link " style={{ backgroundColor: "#ff6a00", borderColor: "#ff6a00" }}
                                ...
                                <li className="page-item">
                                    <Link className="page-link" style={{ color: "#ff6a00" }} to={`/tin-tuc/${slug}/${page + 1}/${limit}`}>
                                        Tiếp
                                    </Link>
                                </li>
                            </ul>
